...
import net.langhoangal.injectablerecyclerviewadapterdemo.R.layout
import net.langhoangal.injectablerecyclerviewadapterdemo.home.model.ImageItem
...
class HomeActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val item8 = ImageItem(0,
        "https://3.imimg.com/data3/FO/SL/MY-3426567/a-global-player-with-a-strong-local-presence-250x250.jpg")
